...
use application\admin\model\Images as M;
/**
 * 图片空间控制器
 */
class Images extends Base{
    ...
    public function checkImages(){
    	...
    	$data['img']=file_exists(MBISRootPath()."/".$imgPath)?true:false;
    	$data['thumb']=file_exists(MBISRootPath()."/".$imgPath_thumb)?true:false;
    	$data['thumbpath']=$imgPath_thumb;
    	$data['mimg']=file_exists(MBISRootPath()."/".$mimg)?true:false;
    	$data['mimgpath']=$mimg;
    	$data['mthumb']=file_exists(MBISRootPath()."/".$mimg_thumb)?true:false;
