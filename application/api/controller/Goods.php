...
class Goods extends Base{
    ...
    */
    ...
    public function add(){
    	...
    	$object['goodsSn'] = MBISGoodsNo();
    	$object['productNo'] = MBISGoodsNo();
    	$object['goodsImg'] = MBISConf('CONF.goodsLogo');
    ...
    public function edit(){
    	...
    	if($object['goodsImg']=='')$object['goodsImg'] = MBISConf('CONF.goodsLogo');
